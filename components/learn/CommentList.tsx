...
const CommentList = ({ materialTitle, materialId }: CommentListProps) => {
    ...
    const {
        ...
        isPending: lessonQuestionsPending,
        totalCount: lessonQuestionsTotalCount,
    } = useLessonQuestions(materialId, {
    ...
    const {
        data: myQuestions,
        isPending: myQuestionsPending,
        totalCount: myQuestionsTotalCount,
    } = useMyQuestions({
    ...
    const totalPages = useMemo(
        () => Math.ceil((lessonQuestionsTotalCount || 0) / QUESTIONS_PER_PAGE),
        [lessonQuestionsTotalCount]
    );
    ...
    const myTotalPages = useMemo(
        () => Math.ceil((myQuestionsTotalCount || 0) / QUESTIONS_PER_PAGE),
        [myQuestionsTotalCount]
    );
            ...
            <View style={styles.container}>
                                ...
                                paginatedQuestions.length === 0 ? (
                                    <View style={styles.emptyContainer}>
                                        ...
                                        <Text style={styles.emptyText}>
                                            Chưa có câu hỏi nào tại bài học này.
                                        </Text>
                                    </View>
                                ) : (
                                    <>
                ...
                <View style={{ marginTop: 32 }}>
                    {myQuestionsPending ? (
                        ...
                        <>
                            <Text style={styles.subtitle}>
                                Các câu hỏi của bạn ({myQuestionsTotalCount})
                            </Text>
                            {!paginatedMyQuestions ||
