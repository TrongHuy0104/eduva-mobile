      ...
      <View style={[styles.richEditorContainer, style]}>
        ...
        <View style={{ paddingBottom: 24 }}>
          <RichEditor
            ref={richTextRef}
            focusable={autoFocus}
            initialContentHTML={replacePImageWithImg(initialContent)}
        ...
        {showLinkDialog && (
          <View style={styles.linkDialogContainer}>
            <View style={styles.linkDialog}>
              ...
              <TextInput
                style={[styles.linkDialogInput, linkUrlError && styles.linkDialogInputError]}
              ...
              <TextInput
                ...
                autoCorrect={false}
              />
              {linkUrlError ? <Text style={styles.linkDialogError}>{linkUrlError}</Text> : null}
              <View style={styles.linkDialogActions}>
                <Text style={styles.linkDialogButton} onPress={() => setShowLinkDialog(false)}>
                  HỦY
                </Text>
                <Text style={[styles.linkDialogButton, styles.linkDialogButtonPrimary]} onPress={handleInsertLink}>
                  CHÈN
                </Text>
              </View>
            </View>
