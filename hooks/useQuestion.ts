...
export const useLessonQuestions = (
    materialId: string,
    ...
    const { data, isPending, error, refetch } = useQuery<
        ...
        Error
    >({
        queryKey: ['lesson-questions', request],
        queryFn: () => {
    ...
    >({
        ...
        onSuccess: (data) => {
            ...
            queryClient.invalidateQueries({
                queryKey: ['question', data.data.data?.id ?? ''],
            });
            toast.success(
...
export const useDeleteQuestion = () => {
    ...
    return useMutation<AxiosResponse<BaseResponse<Question>>, Error, string>({
